...
class ProfileControllerTestIT extends IntegrationTestConfig {
    ...
    @Sql(value = "/sql/profiles/init_two_profiles.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
    @Sql(value = "/sql/profiles/clean_profiles.sql", executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
    @Order(1)
